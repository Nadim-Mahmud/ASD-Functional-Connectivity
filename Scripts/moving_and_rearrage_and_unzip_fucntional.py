...
# base link of A00 formated anonymus subject name

# ***************************** Change Region ***********************************
source = "D:\\Reasearch\\Data\\fmri_data\\um\\dicom\\signa\\mmilham\\abide_28730"
...
for root, dirnames, files in os.walk(source): 
    for x in files: 
        ...
        if x.endswith('.gz'):
            ...
            path = os.path.join(destinition_root + destinition, 'func')
            ...
            anatomy_image_destinition =  path + "\\" + "mri_bold.nii"
